...
```{r}
#sneaky trick: at the top of my scripts, I define the object I call bb_theme which has the ggplot theme options I like to use. That way I don't have to type them all every time. Feel free to use:
...
Don't stop praticing your code!
