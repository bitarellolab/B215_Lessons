...
One of the ways to measure the strength of the association between two categorical variables is an odds ratio. This next section is going to cover a few ways to find odds ratio and relative risk. This in particular is a more tricky concept to grasp, so if you're not familiar I really recommend checking out the slides. 
