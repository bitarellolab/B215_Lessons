...
* spaces are not tolerated -- In fact, in the world of programming you should forget spaces altogether (use underscores, periods, or capitilization if you want to separate words)
when naming things (variables, files, functions, etc.) because they are
a no-no 
* instead of "my var", use "myvar", "myVar", "my_var", etc. 
