...
<<<<<<< HEAD
You're a researcher studying the effect of
 
=======

Calculate the average score for each student using both apply and a for loop. 
Your matrix is called scores and has all the information you need. 
>>>>>>> 4e52fed26af54e1fa5dbaae3f9dd6950ae59d903



```{r setupex3}
cells <- matrix(c(85, 90, 78, 88, 
                   92, 80, 95, 90, 
                   60, 55, 78, 84), 
                 nrow=3, byrow=TRUE)
colnames(cells) <- c("Math", "English", "Biology", "History")
rownames(cells) <- c("Trial 1", "Trial 2", "Trial 3")
print(cells)
