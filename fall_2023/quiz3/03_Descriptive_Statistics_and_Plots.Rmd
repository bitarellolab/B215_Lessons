...
You can also use the `!=` aka the "is not equal to" function to filter for all the rows in dataset without a specific value. This can be useful for when you move on to exploratory data analysis with real world data.
