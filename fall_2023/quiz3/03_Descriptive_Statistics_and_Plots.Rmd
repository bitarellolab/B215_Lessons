...
You can select a subset of variables by name with the `select()` function in `dplyr`. In more practical terms, `select()` pulls rows out of the data frame, while `filter()` pulls out rows. Run the code below to see the narrow data set that `select()` creates.
