...
The summarize function is super useful. This is how you'd use it to group by if someone survived, and get the mean of their ages. print the new data frame to see.
