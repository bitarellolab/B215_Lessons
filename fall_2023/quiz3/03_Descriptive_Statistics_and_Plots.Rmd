...
Let's return to the iris data set for our next example. We have the length and width of the petals, but let's say we wanted to add a row with a (very) rough approximation of the petal area for each of the iris species. 
