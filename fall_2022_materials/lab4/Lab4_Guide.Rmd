...
* this is an R markdown file, so for each exercise, write yoir code inside a code chunk. You can create a code chunk by clicking at the "+C" green rectangle just above this area of your interface
