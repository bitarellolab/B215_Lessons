...
library(learnr)
library(tidyverse)
learnr::tutorial_options(exercise.eval = F)
knitr::opts_chunk$set(error = TRUE, eval = F, echo = T)
```
...
write.csv(x = flower_visits, file = "my_flower_visits.csv", quote = F) #write a file with comma separated columns and do not quote characters/strings
```
