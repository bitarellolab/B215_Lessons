...
I put this file in an URL so that you can practice reading it in:
[https://github.com/bitarellolab/Teaching/blob/c8fd4738895bc800b28bca1b0d15d25273ab382d/B215/data/titanic.csv](https://github.com/bitarellolab/Teaching/blob/c8fd4738895bc800b28bca1b0d15d25273ab382d/B215/data/titanic.csv)

* read in the file and save it as `titanicdata`
* use head on the object `titanicdata`
* use tail on the object
...
```{r ex1-solution}
titanicdata<-read.csv("https://github.com/bitarellolab/Teaching/blob/c8fd4738895bc800b28bca1b0d15d25273ab382d/B215/data/titanic.csv", stringsAsFactors = TRUE)
head(titanicdata)
tail(titanicdata)
