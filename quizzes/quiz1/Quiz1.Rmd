...
date: "`r Sys.Date()`"
<<<<<<< Updated upstream:quizzes/quiz1/Quiz1.Rmd
tutorial:
...
tutorial: 
        id: "Lab1.Quiz"
>>>>>>> Stashed changes:quizzes/01_Quiz.Rmd
---
...
```{r ex1, exercise=TRUE, allow.skip=F}
...
```{r ex2, exercise=TRUE, allow.skip=F}
...
```{r ex4, exercise=TRUE, allow.skip=F}
...
```{r ex5, exercise=TRUE, allow.skip=F}
