...
#is.complex(complex) what do you think this would return?
```
...
On the other hand, there are things that only make sense with characters. For example, the function.
...
```{r sandbox7, exercise=TRUE, eval = FALSE, exercise.setup="setupsandbox7"}
