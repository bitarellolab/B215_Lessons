...
```{r matrix1, exercise = TRUE, allow_skip = FALSE}
...
```{r matrix2, exercise = TRUE, allow_skip = FALSE}
# Create two vectors
vector1 <- c(1, 2, 3)
vector2 <- c(4, 5, 6)
...
You can do this using indexing. In R, you use square brackets [] to index a matrix.

```{r mat2, exercise = TRUE, allow_skip = FALSE}
# Create a matrix
matrix <- matrix(1:9, nrow = 3)

# Use the vector to select the first row and column from the matrix
