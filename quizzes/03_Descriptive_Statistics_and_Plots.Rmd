...
=======
titanicdata <- read.csv("~/Documents/GitHub/B215_Lessons/Lab3/rstudio-export_lab3/datatitanic.csv", stringsAsFactors = TRUE)
>>>>>>> Stashed changes
...
This data has age, sex, class of the passenger and whether or not they survived. 

Lets compare survival odds between classes. Use the group_by() function to group the passengers by class. The summarize() function lets you create a new data frame to look at summary statistics from your original dataset. 
