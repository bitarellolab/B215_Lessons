...
Although we will later learn how to read data from a spredsheet into R, let's start by simpling "loading" data into R. A package called `datasets` (already installed with base R) contains several datasets, including this one. 
