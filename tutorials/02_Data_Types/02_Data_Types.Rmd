---
title: "02. R, Rstudio: Crash Course"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: false
...
-   Complete assignments in Codecamp
-   Complete RQ1
...
Learn more at [R programming language
    explained](https://www.freecodecamp.org/news/r-programming-language-explained/).

## What is RStudio?

[Rstudio](https://www.rstudio.com/) is a separate program, also free, that provides a more
...
programs. [What is a GUI?](https://www.computerhope.com/jargon/g/gui.htm)
...
Learn more at: [Rstudio](https://www.rstudio.com/)

## How does the Rstudio Cloud workspace work?

Join the B215 Rstudio cloud workspace. This space will be updated by the
instructor often, and you will see a mirrored version in your own space.
If the workspace is changed by the instructor, simply refreshing the
page should get you the updated version.
...
Variable names should: \* be meaningful \* they can include letters and
numbers \* they cannot begin with a number \* spaces are not tolerated.
In fact, in the world of programming you should forget spaces altogether
when naming things (variables, files, functions, etc.) because they are
a no-no \* in stead of "my var", use "myvar", "myVar", "my_var", etc. \*
choosing meaningful names makes your code easier to read - by you and
others

`{r=bla, exercise = T} xvar = 2  yvar <- 4 #you can use <- as well for assignments my_result <- (xvar + yvar) * yvar msg = "The result is" print(msg) print(my_result)`

-   Both xcar and yvar are numeric variables.
...
1.  Introduction to R: Intro to Basics
2.  Introduction to R: Vectors
3.  Introduction to R: Factors
